...
public class RoundAngleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            roundWidth = a.getDimensionPixelSize(R.styleable.RoundAngleImageView_roundWidth2, roundWidth);
            roundHeight = a.getDimensionPixelSize(R.styleable.RoundAngleImageView_roundHeight2, roundHeight);
